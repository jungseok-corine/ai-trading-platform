...
from app.api.v1 import strategy_selection as strategy_selection_api
...
from app.api.v1 import leader_trend as leader_trend_api
...
app.include_router(leader_trend_api.router, prefix="/api/v1")
...
app.include_router(strategy_selection_api.router, prefix="/api/v1")
