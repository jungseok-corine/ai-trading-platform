...
export const translations: Record<Language, Translations> = {
  ko: {
    ...
    scheduler: {
      ...
      colSummary: "요약",
      jobLabels: {
        strategy_runner: "전략 실행",
        order_sync: "주문 동기화",
        trading_state_sync: "거래 상태 동기화",
        research_pipeline: "연구 파이프라인",
        data_refresh: "국내 데이터 갱신",
        us_market_refresh: "미국장 갱신",
        daily_analysis: "일일 AI 분석",
        scanner_review: "스캐너 검토",
        strategy_review: "전략 검토",
        daily_report: "일일 리포트",
        operations_digest: "운영 요약",
        dart_ingest: "DART 공시 수집",
        edgar_ingest: "EDGAR 공시 수집",
        intraday_event_monitor: "장중 공시 감시",
        dart_finance: "DART 재무 수집",
        intelligence_ingest: "인텔리전스 수집",
        intelligence_discovery: "후보 발굴",
        intelligence_scanner_proposal: "스캐너 제안",
        intelligence_experiment_autopilot: "실험 자동 점검",
        intelligence_evolution: "전략 진화 루프",
  ...
  en: {
    ...
    scheduler: {
      ...
      jobLabels: {
        ...
        data_refresh: "KR Data Refresh",
        us_market_refresh: "US Market Refresh",
        daily_analysis: "Daily AI Analysis",
        scanner_review: "Scanner Review",
        strategy_review: "Strategy Review",
        daily_report: "Daily Report",
        operations_digest: "Operations Digest",
        dart_ingest: "DART Disclosure Ingest",
        edgar_ingest: "EDGAR Disclosure Ingest",
        intraday_event_monitor: "Intraday Event Monitor",
        dart_finance: "DART Financials",
        intelligence_ingest: "Intelligence Ingest",
        intelligence_discovery: "Candidate Discovery",
        intelligence_scanner_proposal: "Scanner Proposal",
        intelligence_experiment_autopilot: "Experiment Autopilot",
        intelligence_evolution: "Strategy Evolution",
      } as Record<string, string>,
      summaryKeyLabels: {
